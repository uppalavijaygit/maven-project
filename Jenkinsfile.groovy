        ...
        stage ('Deployments'){
            parallel{
                stage ('Deploy to Staging'){
                    steps {
                         bat "pscp -scp -i "V:\\Program Files\\Servers\\keyGen.ppk" "C:\\Program Files (x86)\\Jenkins\\workspace\\maven-project\\webapp\\target\\webapp.war" ec2-user@${params.tomcat_dev}:/opt/apache-tomcat-7.0.91/webapps"
                    }
                }
